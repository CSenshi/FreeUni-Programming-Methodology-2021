...
public class Ex71 extends ConsoleProgram {
	...
	@Override
	public void run() {
		SchoolInterface school = new RefactoredSchool();
	...
	private void addTeachers(SchoolInterface school) {
		school.addTeacher("Shota");
		school.addTeacher("Nika");
		school.addTeacher("Giorgi");
	}

	private void addSubjects(SchoolInterface school) {
		// Shota
	...
	private void addPupils(SchoolInterface school) {
		// Saba
	...
	private void addMoreTeachersAndSubjects(SchoolInterface school) {
		school.addTeacher("Irakli");
		school.addSubject("Irakli", "Programming Methodology");
		school.addSubject("Irakli", "Discrete Math");
	}

	private void testGetPupils(SchoolInterface school) {
	...
	private void testGetTeachers(SchoolInterface school) {
		// 1. Saba
	...
	private void testRemoveTeacher(SchoolInterface school) {
